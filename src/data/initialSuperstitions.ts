...
export const initialSuperstitions: Superstition[] = [
  {
    ...
    origin: 'Ancient Rome',
    believers: 'Many Western cultures and some parts of Asia.',
  ...
  },
  {
    ...
    origin: 'Ancient Egypt / Medieval Europe',
    believers: 'Construction workers and superstitious people globally.',
  ...
  },
  {
    ...
    believers: 'Widely followed in Europe and North America.',
  ...
  },
  {
    ...
    origin: 'Ancient Sumeria / Rome',
    believers: 'Culinary enthusiasts and traditionalists.',
